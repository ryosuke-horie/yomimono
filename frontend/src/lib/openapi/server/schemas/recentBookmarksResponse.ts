 ...
 */
import type { RecentBookmarksResponseBookmarks } from './recentBookmarksResponseBookmarks';
import type { SuccessResponse } from './successResponse';

export type RecentBookmarksResponse = SuccessResponse & {
  /** YYYY-MM-DD をキーにした既読ブックマークリスト */
  bookmarks: RecentBookmarksResponseBookmarks;
};
