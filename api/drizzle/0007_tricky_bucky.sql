...
CREATE TABLE `__new_article_labels` (
	...
	`created_at` integer DEFAULT '"2025-06-01T23:11:25.847Z"' NOT NULL,
...
CREATE TABLE `__new_bookmarks` (
	...
	`created_at` integer DEFAULT '"2025-06-01T23:11:25.846Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2025-06-01T23:11:25.846Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_rss_feed_items` (
	...
	`fetched_at` integer DEFAULT '"2025-06-01T23:11:25.847Z"' NOT NULL,
	`created_at` integer DEFAULT '"2025-06-01T23:11:25.847Z"' NOT NULL,
	FOREIGN KEY (`feed_id`) REFERENCES `rss_feeds`(`id`) ON UPDATE no action ON DELETE no action
);
--> statement-breakpoint
...
CREATE TABLE `__new_rss_feeds` (
	...
	`created_at` integer DEFAULT '"2025-06-01T23:11:25.847Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2025-06-01T23:11:25.847Z"' NOT NULL
);
--> statement-breakpoint
