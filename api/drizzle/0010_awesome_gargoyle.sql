...
CREATE TABLE `__new_article_ratings` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`article_id` integer NOT NULL,
...
--> statement-breakpoint
INSERT INTO `__new_article_ratings`("id", "article_id", "practical_value", "technical_depth", "understanding", "novelty", "importance", "total_score", "comment", "created_at", "updated_at") SELECT "id", "article_id", "practical_value", "technical_depth", "understanding", "novelty", "importance", "total_score", "comment", "created_at", "updated_at" FROM `article_ratings`;--> statement-breakpoint
DROP TABLE `article_ratings`;--> statement-breakpoint
ALTER TABLE `__new_article_ratings` RENAME TO `article_ratings`;--> statement-breakpoint
...
CREATE TABLE `__new_rss_feed_items` (
	...
	`fetched_at` integer DEFAULT '"2025-06-08T12:16:26.002Z"' NOT NULL,
	`created_at` integer DEFAULT '"2025-06-08T12:16:26.002Z"' NOT NULL,
	FOREIGN KEY (`feed_id`) REFERENCES `rss_feeds`(`id`) ON UPDATE no action ON DELETE no action
);
--> statement-breakpoint
