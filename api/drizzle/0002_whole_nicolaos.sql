CREATE TABLE `books` (
	...
	`created_at` integer DEFAULT '"2025-08-02T17:35:32.565Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2025-08-02T17:35:32.565Z"' NOT NULL
);
--> statement-breakpoint
CREATE INDEX `idx_books_status` ON `books` (`status`);--> statement-breakpoint
CREATE INDEX `idx_books_type` ON `books` (`type`);--> statement-breakpoint
CREATE INDEX `idx_books_created_at` ON `books` (`created_at`);--> statement-breakpoint
CREATE INDEX `idx_books_status_created_at` ON `books` (`status`,`created_at`);--> statement-breakpoint
...
CREATE TABLE `__new_bookmarks` (
	...
	`created_at` integer DEFAULT '"2025-08-02T17:35:32.564Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2025-08-02T17:35:32.564Z"' NOT NULL
);
--> statement-breakpoint
