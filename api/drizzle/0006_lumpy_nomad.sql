...
CREATE TABLE `__new_article_labels` (
	...
	`created_at` integer DEFAULT '"2025-05-24T03:45:11.790Z"' NOT NULL,
...
CREATE TABLE `__new_bookmarks` (
	...
	`created_at` integer DEFAULT '"2025-05-24T03:45:11.789Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2025-05-24T03:45:11.789Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_labels` (
	...
	`description` text,
	`created_at` integer DEFAULT '"2025-05-24T03:45:11.790Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2025-05-24T03:45:11.790Z"' NOT NULL
);
--> statement-breakpoint
...
CREATE TABLE `__new_rss_feed_items` (
	...
	`fetched_at` integer DEFAULT '"2025-05-24T03:45:11.790Z"' NOT NULL,
	`created_at` integer DEFAULT '"2025-05-24T03:45:11.790Z"' NOT NULL,
	FOREIGN KEY (`feed_id`) REFERENCES `rss_feeds`(`id`) ON UPDATE no action ON DELETE no action
);
--> statement-breakpoint
