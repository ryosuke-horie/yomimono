...
CREATE TABLE `__new_article_labels` (
	...
	`created_at` integer DEFAULT '"2025-05-03T13:26:30.000Z"' NOT NULL,
...
CREATE TABLE `__new_bookmarks` (
	...
	`created_at` integer DEFAULT '"2025-05-03T13:26:30.000Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2025-05-03T13:26:30.000Z"' NOT NULL
);
--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_labels`("id", "name", "created_at", "updated_at") SELECT "id", "name", "created_at", "updated_at" FROM `labels`;--> statement-breakpoint
