    ...
    <div className="border rounded-lg p-4 mb-4 shadow-sm hover:shadow-md transition-shadow">
      ...
      {!bookmark.summary && (
        <div className="mt-3 mb-3 p-3 bg-gray-50 rounded-md border border-dashed border-gray-300">
          <button
            onClick={() => onGenerateSummary?.(bookmark.id)}
...
```tsx
const SummaryGenerating: React.FC = () => {
  return (
    <div className="mt-3 mb-3 p-3 bg-gray-50 rounded-md border border-gray-200 animate-pulse">
      <div className="flex items-center gap-2">
        <div className="w-4 h-4 bg-blue-500 rounded-full animate-spin" />
        <span className="text-sm text-gray-600">要約を生成中...</span>
      </div>
    </div>
  );
};
